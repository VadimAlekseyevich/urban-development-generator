...
**S10-T09 Capacity/site feasibility завершён**; **S10-T10 persistence реализован до writer-слоя**: UG-AI-033 добавляет typed GeneratedInfrastructure schema/migration, UG-AI-034 — bounded retry-safe writer.
