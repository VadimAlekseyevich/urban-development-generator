...
**Sprint S11 завершён; M2 First Complete Deterministic Scenario закрыт. S12 реализован through UG-AI-063**: canonical `StageRegistry` валидирует DAG, строит deterministic topological plan и явно распространяет skip только по downstream dependencies без смешивания skip с checkpoint reuse.
...
**`UG-AI-064 / S12-T02`** из `docs/07-planning/AI_EXECUTION_TASKS.md`.
