...
Текущая feature-точка — **S10-T08 Infrastructure placement**: UG-AI-025..026 реализованы поверх завершённого S10-T07.
...
**`UG-AI-027 / S10-T08`** из `docs/07-planning/AI_EXECUTION_TASKS.md`.
