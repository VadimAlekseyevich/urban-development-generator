...
Текущая feature-точка — **S10-T06 Infrastructure network snapping завершён**: UG-AI-015..019 закрыты.
...
**`UG-AI-020 / S10-T07`** из `docs/07-planning/AI_EXECUTION_TASKS.md`.
