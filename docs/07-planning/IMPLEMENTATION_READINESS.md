...
The repository is architecture-ready for S10 feature development. S10-T06 is complete; the current ordered task is **UG-AI-024 / S10-T07**.
...
```text
UG-AI-024 / S10-T07
Add deterministic synthetic graph tests and path-search budget/performance assertions.
```
